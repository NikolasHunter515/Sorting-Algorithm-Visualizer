    ...
    return(
        <div className="row">
            <div className="col-auto">
                <button onClick={() => setCase("sorted")} className="btn">Sorted</button>
                <button onClick={() => setCase("random")} className="btn">Random</button>
                <button onClick={() => setCase("reverse")} className="btn">Reverse</button>
            </div>
        </div>
    );
}